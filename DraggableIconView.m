...
- (void)mouseDown: (NSEvent*)event
{
	...
	if (![[delegate selectedFilePath] isEqualToString: @""])
	{
		[dragPasteboard declareTypes: [NSArray arrayWithObject: NSFilenamesPboardType] owner: self];
		[dragPasteboard setPropertyList: [NSArray arrayWithObject: [delegate selectedFilePath]] forType: NSFilenamesPboardType];
	}
